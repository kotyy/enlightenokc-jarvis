...
module.exports = (robot) ->
  ...
  missionMapUrl = (coords) ->
    return "https://www.google.com/fusiontables/embedviz?q=select+col8+from+1IdtxAhxrcFFafLiPDLhoQsonk8LDxuMZzqoKiUIl&viz=MAP&h=false&lat=" + encodeURIComponent(coords.lat) + "&lng=" + encodeURIComponent(coords.lng) + "&t=1&z=16&l=col8&y=2&tmplt=2&hml=TWO_COL_LAT_LNG"
